...
public class AgentWeb {
    ...
    private AgentWeb(AgentBuilder agentBuilder) {
        ...
        mWebCreator = agentBuilder.mWebCreator == null ? configWebCreator(agentBuilder.v,
                agentBuilder.index, agentBuilder.mLayoutParams, agentBuilder.mIndicatorColor,
                agentBuilder.mIndicatorColorWithHeight, agentBuilder.mWebView) : agentBuilder
                .mWebCreator;
    ...
    private AgentWeb(AgentBuilderFragment agentBuilderFragment) {
        ...
        mWebCreator = agentBuilderFragment.mWebCreator == null ? configWebCreator
                (agentBuilderFragment.v, agentBuilderFragment.index, agentBuilderFragment
                        .mLayoutParams, agentBuilderFragment.mIndicatorColor,
                        agentBuilderFragment.height_dp, agentBuilderFragment.mWebView) :
    ...
    private void doCompat() {
        ...
        mJavaObjects.put("agentWeb", mAgentWebJsInterfaceCompat = new AgentWebJsInterfaceCompat
                (this, mActivity));

        LogUtils.i("Info", "AgentWebConfig.isUseAgentWebView:" + AgentWebConfig.WEBVIEW_TYPE + " " +
        ...
        if (AgentWebConfig.WEBVIEW_TYPE == AgentWebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE) {
            this.mChromeClientCallbackManager.setAgentWebCompatInterface(
                    (ChromeClientCallbackManager.AgentWebCompatInterface) mWebCreator.get());
            this.mWebViewClientCallbackManager.setPageLifeCycleCallback(
                    (WebViewClientCallbackManager.PageLifeCycleCallback) mWebCreator.get());
        }
    ...
    private void doSafeCheck() {
        ...
        if (mWebSecurityCheckLogic == null) {
            this.mWebSecurityCheckLogic = mWebSecurityCheckLogic = WebSecurityLogicImpl
                    .getInstance();
        }
    ...
    private WebCreator configWebCreator(BaseIndicatorView progressView, int index, ViewGroup
            .LayoutParams lp, int mIndicatorColor, int height_dp, WebView webView) {
    ...
    private void loadDataWithBaseURL(String baseUrl, String data, String mimeType, String
            encoding, String history) {
    ...
    public JsEntraceAccess getJsEntraceAccess() {
        ...
        if (mJsEntraceAccess == null) {
            this.mJsEntraceAccess = mJsEntraceAccess = JsEntraceAccessImpl.getInstance
                    (mWebCreator.get());
        }
    ...
    private void setLoadListener(List<DownLoadResultListener> downLoadResultListeners) {
        ...
        if (mDownloadListener == null) {
            this.mDownloadListener = mDownloadListener = new DefaultDownLoaderImpl(mActivity
                    .getApplicationContext(), false, true, downLoadResultListeners);
        }
    }
    ...
    private WebChromeClient getChromeClient() {
        IndicatorController mIndicatorController = (this.mIndicatorController == null) ?
                IndicatorHandler.getInstance().inJectProgressView(mWebCreator.offer()) : this
        ...
        return this.mTargetChromeClient = new DefaultChromeClient(this.mActivity,
                mIndicatorController, mWebChromeClient, this.mChromeClientCallbackManager, this
                .mIVideo = getIVideo());
    }
    ...
    private WebViewClient getClient() {
        if (!webClientHelper && AgentWebConfig.WEBVIEW_TYPE != AgentWebConfig
                .WEBVIEW_AGENTWEB_SAFE_TYPE && mWebViewClient != null) {
            return mWebViewClient;
        } else {
            return new DefaultWebClient(mActivity, this.mWebViewClient, this
                    .mWebViewClientCallbackManager, webClientHelper);
        }
    ...
    public static class AgentBuilder {
        ...
        private ChromeClientCallbackManager mChromeClientCallbackManager = new
        ...
        public ConfigIndicatorBuilder setAgentWebParent(ViewGroup viewGroup, ViewGroup
                .LayoutParams lp) {
...
//
    ...
    public static class PreAgentWeb {
        ...
        public AgentWeb go(@Nullable String url) {
            if (!isReady) {
//                throw new IllegalStateException(" please call ready before go  to finish all
// webview settings");  //i want to do this , but i cannot;
                ready();
            }
    ...
    public static class CommonAgentBuilder {
        ...
        public CommonAgentBuilder setReceivedTitleCallback(@Nullable ChromeClientCallbackManager
                .ReceivedTitleCallback receivedTitleCallback) {
            this.mAgentBuilder.mChromeClientCallbackManager.setReceivedTitleCallback
        ...
        public CommonAgentBuilder addDownLoadResultListener(DownLoadResultListener
    ...
    public static final class AgentBuilderFragment {
        ...
        public IndicatorBuilderForFragment setAgentWebParent(@NonNull ViewGroup v, @NonNull
    ...
    public static class IndicatorBuilderForFragment {
        ...
        public CommonBuilderForFragment setIndicatorColorWithHeight(@ColorInt int color, int
                height_dp) {
            this.agentBuilderFragment.mIndicatorColor = color;
    ...
    public static class CommonBuilderForFragment {
        ...
        public CommonBuilderForFragment setWebChromeClient(@Nullable WebChromeClient
                                                                   webChromeClient) {
        ...
        public CommonBuilderForFragment setReceivedTitleCallback(@Nullable
        ...
        public CommonBuilderForFragment addJavascriptInterface(@NonNull String name, @NonNull
                Object o) {
        ...
        public CommonBuilderForFragment addDownLoadResultListener(DownLoadResultListener
                                                                          downLoadResultListener) {
