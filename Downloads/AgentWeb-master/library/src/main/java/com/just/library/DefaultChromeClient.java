...
public class DefaultChromeClient extends WebChromeClientProgressWrapper implements
        FileUploadPop<IFileUploadChooser> {
    ...
    public DefaultChromeClient(Activity activity, IndicatorController indicatorController,
                               WebChromeClient chromeClient, ChromeClientCallbackManager
                                       chromeClientCallbackManager, @Nullable IVideo iVideo) {
...
//        this.mActivity = activity;
    ...
    public void onProgressChanged(WebView view, int newProgress) {
        ...
        if (AgentWebConfig.WEBVIEW_TYPE == AgentWebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE &&
                mChromeClientCallbackManager != null && (mAgentWebCompatInterface =
                mChromeClientCallbackManager.getAgentWebCompatInterface()) != null) {
    ...
    public void onReceivedTitle(WebView view, String title) {
        ...
        if (mChromeClientCallbackManager != null && (mCallback = mChromeClientCallbackManager
                .getReceivedTitleCallback()) != null)
            mCallback.onReceivedTitle(view, title);

        if (AgentWebConfig.WEBVIEW_TYPE == AgentWebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE &&
                mChromeClientCallbackManager != null && (mChromeClientCallbackManager
                .getAgentWebCompatInterface()) != null)
    ...
    public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
        ...
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onJsAlert", "public boolean " +
                ChromePath + ".onJsAlert", WebView.class, String.class, String.class, JsResult
                .class)) {
    ...
    public void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback
        ...
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient,
                "onGeolocationPermissionsShowPrompt", "public void " + ChromePath + "" +
                        ".onGeolocationPermissionsShowPrompt", String.class,
    ...
    public boolean onJsPrompt(WebView view, String url, String message, String defaultValue,
        ...
        try {
            if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onJsPrompt", "public boolean "
                    + ChromePath + ".onJsPrompt", WebView.class, String.class, String.class,
                    String.class, JsPromptResult.class)) {
            ...
            if (AgentWebConfig.WEBVIEW_TYPE == AgentWebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE &&
                ...
                LogUtils.i("Info", "mChromeClientCallbackManager.getAgentWebCompatInterface():" +
                        mChromeClientCallbackManager.getAgentWebCompatInterface());
                if (mChromeClientCallbackManager.getAgentWebCompatInterface().onJsPrompt(view,
...
//            e.printStackTrace();
    ...
    public boolean onJsConfirm(WebView view, String url, String message, JsResult result) {
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onJsConfirm", "public boolean " +
                ChromePath + ".onJsConfirm", WebView.class, String.class, String.class, JsResult
                .class)) {
    ...
    public void onExceededDatabaseQuota(String url, String databaseIdentifier, long quota, long
            estimatedDatabaseSize, long totalQuota, WebStorage.QuotaUpdater quotaUpdater) {


        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onExceededDatabaseQuota",
                ChromePath + ".onExceededDatabaseQuota", String.class, String.class, long.class,
                long.class, long.class, WebStorage.QuotaUpdater.class)) {
    ...
    public void onReachedMaxAppCacheSize(long requiredStorage, long quota, WebStorage
        ...
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onReachedMaxAppCacheSize",
                ChromePath + ".onReachedMaxAppCacheSize", long.class, long.class, WebStorage
                        .QuotaUpdater.class)) {
    ...
    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback,
        ...
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onShowFileChooser", ChromePath + "" +
                ".onShowFileChooser", WebView.class, ValueCallback.class, FileChooserParams
                .class)) {
    ...
    private void openFileChooserAboveL(WebView webView, ValueCallback<Uri[]> filePathCallback,
                                       FileChooserParams fileChooserParams) {
        ...
        this.mIFileUploadChooser = mIFileUploadChooser = new FileUpLoadChooserImpl(webView,
                mActivity, filePathCallback, fileChooserParams);
    ...
    public void openFileChooser(ValueCallback<Uri> uploadFile, String acceptType, String capture) {
        ...
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "openFileChooser", ChromePath + "" +
                ".openFileChooser", ValueCallback.class, String.class, String.class)) {
    ...
    public void openFileChooser(ValueCallback<Uri> valueCallback) {
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "openFileChooser", ChromePath + "" +
                ".openFileChooser", ValueCallback.class)) {
    ...
    public void openFileChooser(ValueCallback valueCallback, String acceptType) {
        ...
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "openFileChooser", ChromePath + "" +
                ".openFileChooser", ValueCallback.class, String.class)) {
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        LogUtils.i("Info", "consoleMessage:" + consoleMessage.message() + "  lineNumber:" +
    ...
    public void onShowCustomView(View view, CustomViewCallback callback) {
        ...
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onShowCustomView", ChromePath + "" +
    ...
    public void onHideCustomView() {
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onHideCustomView", ChromePath + "" +
                ".onHideCustomView", View.class, CustomViewCallback.class)) {
